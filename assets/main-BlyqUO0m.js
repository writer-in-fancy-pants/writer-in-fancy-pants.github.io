...
`;function i(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var a=i();function o(e){a=e}var s=/[&<>"']/,c=new RegExp(s.source,`g`),l=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,u=new RegExp(l.source,`g`),d={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},f=e=>d[e];function p(e,t){if(t){if(s.test(e))return e.replace(c,f)}else if(l.test(e))return e.replace(u,f);return e}var ee=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function te(e){return e.replace(ee,(e,t)=>(t=t.toLowerCase(),t===`colon`?`:`:t.charAt(0)===`#`?t.charAt(1)===`x`?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):``))}var ne=/(^|[^\[])\^/g;function m(e,t){let n=typeof e==`string`?e:e.source;t||=``;let r={replace:(e,t)=>{let i=typeof t==`string`?t:t.source;return i=i.replace(ne,`$1`),n=n.replace(e,i),r},getRegex:()=>new RegExp(n,t)};return r}function h(e){try{e=encodeURI(e).replace(/%25/g,`%`)}catch{return null}return e}var g={exec:()=>null};function _(e,t){let n=e.replace(/\|/g,(e,t,n)=>{let r=!1,i=t;for(;--i>=0&&n[i]===`\\`;)r=!r;return r?`|`:` |`}).split(/ \|/),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n[n.length-1].trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push(``);for(;r<n.length;r++)n[r]=n[r].trim().replace(/\\\|/g,`|`);return n}function v(e,t,n){let r=e.length;if(r===0)return``;let i=0;for(;i<r;){let a=e.charAt(r-i-1);if(a===t&&!n)i++;else if(a!==t&&n)i++;else break}return e.slice(0,r-i)}function re(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let r=0;r<e.length;r++)if(e[r]===`\\`)r++;else if(e[r]===t[0])n++;else if(e[r]===t[1]&&(n--,n<0))return r;return-1}function y(e,t,n,r){let i=t.href,a=t.title?p(t.title):null,o=e[1].replace(/\\([\[\]])/g,`$1`);if(e[0].charAt(0)!==`!`){r.state.inLink=!0;let e={type:`link`,raw:n,href:i,title:a,text:o,tokens:r.inlineTokens(o)};return r.state.inLink=!1,e}return{type:`image`,raw:n,href:i,title:a,text:p(o)}}function ie(e,t){let n=e.match(/^(\s+)(?:```)/);if(n===null)return t;let r=n[1];return t.split(`
`).map(e=>{let t=e.match(/^\s+/);if(t===null)return e;let[n]=t;return n.length>=r.length?e.slice(r.length):e}).join(`
`)}var b=class{options;rules;lexer;constructor(e){this.options=e||a}space(e){let t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:`space`,raw:t[0]}}code(e){let t=this.rules.block.code.exec(e);if(t){let e=t[0].replace(/^ {1,4}/gm,``);return{type:`code`,raw:t[0],codeBlockStyle:`indented`,text:this.options.pedantic?e:v(e,`
`)}}}fences(e){let t=this.rules.block.fences.exec(e);if(t){let e=t[0],n=ie(e,t[3]||``);return{type:`code`,raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,`$1`):t[2],text:n}}}heading(e){let t=this.rules.block.heading.exec(e);if(t){let e=t[2].trim();if(/#$/.test(e)){let t=v(e,`#`);(this.options.pedantic||!t||/ $/.test(t))&&(e=t.trim())}return{type:`heading`,raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(e){let t=this.rules.block.hr.exec(e);if(t)return{type:`hr`,raw:t[0]}}blockquote(e){let t=this.rules.block.blockquote.exec(e);if(t){let e=t[0].replace(/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,`
    $1`);e=v(e.replace(/^ *>[ \t]?/gm,``),`
...
`+e+`</thead>
`+t+`</table>
`}tablerow(e){return`<tr>\n${e}</tr>\n`}tablecell(e,t){let n=t.header?`th`:`td`;return(t.align?`<${n} align="${t.align}">`:`<${n}>`)+e+`</${n}>\n`}strong(e){return`<strong>${e}</strong>`}em(e){return`<em>${e}</em>`}codespan(e){return`<code>${e}</code>`}br(){return`<br>`}del(e){return`<del>${e}</del>`}link(e,t,n){let r=h(e);if(r===null)return n;e=r;let i=`<a href="`+e+`"`;return t&&(i+=` title="`+t+`"`),i+=`>`+n+`</a>`,i}image(e,t,n){let r=h(e);if(r===null)return n;e=r;let i=`<img src="${e}" alt="${n}"`;return t&&(i+=` title="${t}"`),i+=`>`,i}text(e){return e}},B=class{strong(e){return e}em(e){return e}codespan(e){return e}del(e){return e}html(e){return e}text(e){return e}link(e,t,n){return``+n}image(e,t,n){return``+n}br(){return``}},V=class e{options;renderer;textRenderer;constructor(e){this.options=e||a,this.options.renderer=this.options.renderer||new z,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new B}static parse(t,n){return new e(n).parse(t)}static parseInline(t,n){return new e(n).parseInline(t)}parse(e,t=!0){let n=``;for(let r=0;r<e.length;r++){let i=e[r];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[i.type]){let e=i,t=this.options.extensions.renderers[e.type].call({parser:this},e);if(t!==!1||![`space`,`hr`,`heading`,`code`,`table`,`blockquote`,`list`,`html`,`paragraph`,`text`].includes(e.type)){n+=t||``;continue}}switch(i.type){case`space`:continue;case`hr`:n+=this.renderer.hr();continue;case`heading`:{let e=i;n+=this.renderer.heading(this.parseInline(e.tokens),e.depth,te(this.parseInline(e.tokens,this.textRenderer)));continue}case`code`:{let e=i;n+=this.renderer.code(e.text,e.lang,!!e.escaped);continue}case`table`:{let e=i,t=``,r=``;for(let t=0;t<e.header.length;t++)r+=this.renderer.tablecell(this.parseInline(e.header[t].tokens),{header:!0,align:e.align[t]});t+=this.renderer.tablerow(r);let a=``;for(let t=0;t<e.rows.length;t++){let n=e.rows[t];r=``;for(let t=0;t<n.length;t++)r+=this.renderer.tablecell(this.parseInline(n[t].tokens),{header:!1,align:e.align[t]});a+=this.renderer.tablerow(r)}n+=this.renderer.table(t,a);continue}case`blockquote`:{let e=i,t=this.parse(e.tokens);n+=this.renderer.blockquote(t);continue}case`list`:{let e=i,t=e.ordered,r=e.start,a=e.loose,o=``;for(let t=0;t<e.items.length;t++){let n=e.items[t],r=n.checked,i=n.task,s=``;if(n.task){let e=this.renderer.checkbox(!!r);a?n.tokens.length>0&&n.tokens[0].type===`paragraph`?(n.tokens[0].text=e+` `+n.tokens[0].text,n.tokens[0].tokens&&n.tokens[0].tokens.length>0&&n.tokens[0].tokens[0].type===`text`&&(n.tokens[0].tokens[0].text=e+` `+n.tokens[0].tokens[0].text)):n.tokens.unshift({type:`text`,text:e+` `}):s+=e+` `}s+=this.parse(n.tokens,a),o+=this.renderer.listitem(s,i,!!r)}n+=this.renderer.list(o,t,r);continue}case`html`:{let e=i;n+=this.renderer.html(e.text,e.block);continue}case`paragraph`:{let e=i;n+=this.renderer.paragraph(this.parseInline(e.tokens));continue}case`text`:{let a=i,o=a.tokens?this.parseInline(a.tokens):a.text;for(;r+1<e.length&&e[r+1].type===`text`;)a=e[++r],o+=`
`+(a.tokens?this.parseInline(a.tokens):a.text);n+=t?this.renderer.paragraph(o):o;continue}default:{let e=`Token with "`+i.type+`" type was not found.`;if(this.options.silent)return console.error(e),``;throw Error(e)}}}return n}parseInline(e,t){t||=this.renderer;let n=``;for(let r=0;r<e.length;r++){let i=e[r];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[i.type]){let e=this.options.extensions.renderers[i.type].call({parser:this},i);if(e!==!1||![`escape`,`html`,`link`,`image`,`strong`,`em`,`codespan`,`br`,`del`,`text`].includes(i.type)){n+=e||``;continue}}switch(i.type){case`escape`:{let e=i;n+=t.text(e.text);break}case`html`:{let e=i;n+=t.html(e.text);break}case`link`:{let e=i;n+=t.link(e.href,e.title,this.parseInline(e.tokens,t));break}case`image`:{let e=i;n+=t.image(e.href,e.title,e.text);break}case`strong`:{let e=i;n+=t.strong(this.parseInline(e.tokens,t));break}case`em`:{let e=i;n+=t.em(this.parseInline(e.tokens,t));break}case`codespan`:{let e=i;n+=t.codespan(e.text);break}case`br`:n+=t.br();break;case`del`:{let e=i;n+=t.del(this.parseInline(e.tokens,t));break}case`text`:{let e=i;n+=t.text(e.text);break}default:{let e=`Token with "`+i.type+`" type was not found.`;if(this.options.silent)return console.error(e),``;throw Error(e)}}}return n}},H=class{options;constructor(e){this.options=e||a}static passThroughHooks=new Set([`preprocess`,`postprocess`,`processAllTokens`]);preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}},U=new class{defaults=i();options=this.setOptions;parse=this.#e(R.lex,V.parse);parseInline=this.#e(R.lexInline,V.parseInline);Parser=V;Renderer=z;TextRenderer=B;Lexer=R;Tokenizer=b;Hooks=H;constructor(...e){this.use(...e)}walkTokens(e,t){let n=[];for(let r of e)switch(n=n.concat(t.call(this,r)),r.type){case`table`:{let e=r;for(let r of e.header)n=n.concat(this.walkTokens(r.tokens,t));for(let r of e.rows)for(let e of r)n=n.concat(this.walkTokens(e.tokens,t));break}case`list`:{let e=r;n=n.concat(this.walkTokens(e.items,t));break}default:{let e=r;this.defaults.extensions?.childTokens?.[e.type]?this.defaults.extensions.childTokens[e.type].forEach(r=>{let i=e[r].flat(1/0);n=n.concat(this.walkTokens(i,t))}):e.tokens&&(n=n.concat(this.walkTokens(e.tokens,t)))}}return n}use(...e){let t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(e=>{let n={...e};if(n.async=this.defaults.async||n.async||!1,e.extensions&&(e.extensions.forEach(e=>{if(!e.name)throw Error(`extension name required`);if(`renderer`in e){let n=t.renderers[e.name];n?t.renderers[e.name]=function(...t){let r=e.renderer.apply(this,t);return r===!1&&(r=n.apply(this,t)),r}:t.renderers[e.name]=e.renderer}if(`tokenizer`in e){if(!e.level||e.level!==`block`&&e.level!==`inline`)throw Error(`extension level must be 'block' or 'inline'`);let n=t[e.level];n?n.unshift(e.tokenizer):t[e.level]=[e.tokenizer],e.start&&(e.level===`block`?t.startBlock?t.startBlock.push(e.start):t.startBlock=[e.start]:e.level===`inline`&&(t.startInline?t.startInline.push(e.start):t.startInline=[e.start]))}`childTokens`in e&&e.childTokens&&(t.childTokens[e.name]=e.childTokens)}),n.extensions=t),e.renderer){let t=this.defaults.renderer||new z(this.defaults);for(let n in e.renderer){if(!(n in t))throw Error(`renderer '${n}' does not exist`);if(n===`options`)continue;let r=n,i=e.renderer[r],a=t[r];t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n||``}}n.renderer=t}if(e.tokenizer){let t=this.defaults.tokenizer||new b(this.defaults);for(let n in e.tokenizer){if(!(n in t))throw Error(`tokenizer '${n}' does not exist`);if([`options`,`rules`,`lexer`].includes(n))continue;let r=n,i=e.tokenizer[r],a=t[r];t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n}}n.tokenizer=t}if(e.hooks){let t=this.defaults.hooks||new H;for(let n in e.hooks){if(!(n in t))throw Error(`hook '${n}' does not exist`);if(n===`options`)continue;let r=n,i=e.hooks[r],a=t[r];H.passThroughHooks.has(n)?t[r]=e=>{if(this.defaults.async)return Promise.resolve(i.call(t,e)).then(e=>a.call(t,e));let n=i.call(t,e);return a.call(t,n)}:t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n}}n.hooks=t}if(e.walkTokens){let t=this.defaults.walkTokens,r=e.walkTokens;n.walkTokens=function(e){let n=[];return n.push(r.call(this,e)),t&&(n=n.concat(t.call(this,e))),n}}this.defaults={...this.defaults,...n}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return R.lex(e,t??this.defaults)}parser(e,t){return V.parse(e,t??this.defaults)}#e(e,t){return(n,r)=>{let i={...r},a={...this.defaults,...i};this.defaults.async===!0&&i.async===!1&&(a.silent||console.warn(`marked(): The async option was set to true by an extension. The async: false option sent to parse will be ignored.`),a.async=!0);let o=this.#t(!!a.silent,!!a.async);if(n==null)return o(Error(`marked(): input parameter is undefined or null`));if(typeof n!=`string`)return o(Error(`marked(): input parameter is of type `+Object.prototype.toString.call(n)+`, string expected`));if(a.hooks&&(a.hooks.options=a),a.async)return Promise.resolve(a.hooks?a.hooks.preprocess(n):n).then(t=>e(t,a)).then(e=>a.hooks?a.hooks.processAllTokens(e):e).then(e=>a.walkTokens?Promise.all(this.walkTokens(e,a.walkTokens)).then(()=>e):e).then(e=>t(e,a)).then(e=>a.hooks?a.hooks.postprocess(e):e).catch(o);try{a.hooks&&(n=a.hooks.preprocess(n));let r=e(n,a);a.hooks&&(r=a.hooks.processAllTokens(r)),a.walkTokens&&this.walkTokens(r,a.walkTokens);let i=t(r,a);return a.hooks&&(i=a.hooks.postprocess(i)),i}catch(e){return o(e)}}}#t(e,t){return n=>{if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+p(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}};function W(e,t){return U.parse(e,t)}W.options=W.setOptions=function(e){return U.setOptions(e),W.defaults=U.defaults,o(W.defaults),W},W.getDefaults=i,W.defaults=a,W.use=function(...e){return U.use(...e),W.defaults=U.defaults,o(W.defaults),W},W.walkTokens=function(e,t){return U.walkTokens(e,t)},W.parseInline=U.parseInline,W.Parser=V,W.parser=V.parse,W.Renderer=z,W.TextRenderer=B,W.Lexer=R,W.lexer=R.lex,W.Tokenizer=b,W.Hooks=H,W.parse=W,W.options,W.setOptions,W.use,W.walkTokens,W.parseInline,V.parse,R.lex;var Me=Object.assign({"/blog/00-quest-to-be-real.md":e,"/blog/01-approaching-truth.md":t,"/blog/02-what-im-reading-q1-2026.md":n,"/blog/03-analyzing-healing-crystals-report.md":r});function Ne(e){let t={},n=e.match(/^---\r?\n([\s\S]*?)\r?\n---\r?\n([\s\S]*)$/m);if(!n)return{meta:t,body:e};let[,r,i]=n;for(let e of r.split(`
`)){let n=e.indexOf(`:`);if(n===-1)continue;let r=e.slice(0,n).trim(),i=e.slice(n+1).trim();(i.startsWith(`"`)&&i.endsWith(`"`)||i.startsWith(`'`)&&i.endsWith(`'`))&&(i=i.slice(1,-1)),t[r]=i}return{meta:t,body:i.trim()}}function Pe(){let e=[];for(let[,t]of Object.entries(Me)){let{meta:n,body:r}=Ne(t);!n.id||!n.title||e.push({id:n.id,title:n.title,date:n.date||``,topic:n.topic||`General`,excerpt:n.excerpt||``,html:W.parse(r),comments:[]})}return e.sort((e,t)=>t.date.localeCompare(e.date))}var Fe=[{name:`Muse 2 EEG Dashboard`,status:`active`,desc:`Dashboard to visualize and compare EEG sessions using various neurofeedback metrics and frequency spectrum power distribution. Upload csv files with "timestamps,TF9,AF7,AF8,TF10" header and signal ordering. Other recordings should be converted to this format before uploading using conversion tools provided in the repo`,tags:[`eeg`,`neurofeedback`,`python`,`js`,`open source`,`dashboard`],links:[{label:`GitHub`,url:`https://github.com/writer-in-fancy-pants/muse2-eeg-dashboard`,primary:!1},{label:`Dashboard`,url:`https://writer-in-fancy-pants.github.io/muse2-eeg-dashboard/`,primary:!0}]},{name:`Meditations`,status:`active`,desc:`Live neurofeedback / biofeedback training and monitored meditation via stream from health devices (EEG, Heart rate, etc).`,tags:[`alpha/theta`,`hrv`,`neurofeedback`,`python`,`audio`,`js`,`open source`],links:[{label:`GitHub`,url:`https://github.com/writer-in-fancy-pants/meditations`,primary:!1},{label:`Dashboard`,url:`https://writer-in-fancy-pants.github.io/meditations/`,primary:!0}]},{name:`Mind Acoustic Tools`,status:`active`,desc:`Tools that use spatial (stereo) audio. Currently supports Hearing Test, EMDR self-therapy, and guided meditations. Work in progress, would love feedback on expected features.`,tags:[`audio`,`emdr`,`python`,`js`,`open source`,`dashboard`],links:[{label:`GitHub`,url:`https://github.com/writer-in-fancy-pants/mind-audio-tools`,primary:!1},{label:`Dashboard`,url:`https://writer-in-fancy-pants.github.io/mind-audio-tools/`,primary:!0}]}];function Ie(){G(localStorage.getItem(`theme`)||`dark`)}function G(e){document.documentElement.setAttribute(`data-theme`,e),localStorage.setItem(`theme`,e);let t=document.getElementById(`theme-toggle`);t&&(t.textContent=e===`dark`?`☀️ Light`:`🌙 Dark`)}function Le(){G(document.documentElement.getAttribute(`data-theme`)===`dark`?`light`:`dark`)}function K(e){document.querySelectorAll(`.page`).forEach(e=>e.classList.remove(`active`)),document.querySelectorAll(`.nav-tabs button`).forEach(e=>e.classList.remove(`active`)),document.getElementById(e).classList.add(`active`),document.getElementById(`tab-`+e).classList.add(`active`)}var q=[],J={},Y=!1,X=null;function Z(e,t){let n=document.getElementById(`posts-container`);n.innerHTML=``;let r=document.querySelector(`.blog-page-title`);if(r.innerHTML=t||`Writing`,t){let e=document.createElement(`a`);e.href=`#`,e.style.cssText=`font-size:.8rem;color:var(--accent);margin-left:.7rem;`,e.textContent=`(clear)`,e.onclick=e=>{e.preventDefault(),Z(q)},r.appendChild(e)}let i=e||q;if(!i.length){n.innerHTML=`<p style="color:var(--muted);font-size:.9rem;padding:1.5rem 0;">No posts found.</p>`;return}i.forEach(e=>{let t=document.createElement(`div`);t.className=`post-card`,t.innerHTML=`
      <div class="post-meta">
        <span class="post-tag">${e.topic}</span>
        <span>${$(e.date)}</span>
      </div>
      <a class="post-title" href="#" data-id="${e.id}">${e.title}</a>
      <p class="post-excerpt">${e.excerpt}</p>
      <a class="read-more" href="#" data-id="${e.id}">Read more →</a>
    `,t.querySelectorAll(`[data-id]`).forEach(t=>t.addEventListener(`click`,t=>{t.preventDefault(),ze(e.id)})),n.appendChild(t)})}function Re(){let e=[...new Set(q.map(e=>e.topic))],t=document.getElementById(`topic-index`);t.innerHTML=e.map(e=>`<li><a href="#" class="topic-tag" data-topic="${e}">${e}</a></li>`).join(``),t.querySelectorAll(`[data-topic]`).forEach(e=>e.addEventListener(`click`,t=>{t.preventDefault();let n=e.dataset.topic;Z(q.filter(e=>e.topic===n),`Topic: ${n}`)}));let n={};q.forEach(e=>{let t=e.date.slice(0,7);n[t]||(n[t]=[]),n[t].push(e)});let r=document.getElementById(`date-index`);r.innerHTML=Object.entries(n).sort(([e],[t])=>t.localeCompare(e)).map(([e,t])=>`<li><a href="#" style="font-weight:500;" data-ym="${e}">${new Date(e+`-01`).toLocaleDateString(`en-US`,{month:`short`,year:`numeric`})}</a></li>${t.map(e=>`<li><a href="#" style="padding-left:.7rem;" data-id="${e.id}">↳ ${e.title.length>28?e.title.slice(0,28)+`…`:e.title}</a></li>`).join(``)}`).join(``),r.querySelectorAll(`[data-id]`).forEach(e=>e.addEventListener(`click`,t=>{t.preventDefault(),ze(e.dataset.id)})),r.querySelectorAll(`[data-ym]`).forEach(e=>e.addEventListener(`click`,t=>{t.preventDefault();let n=e.dataset.ym,r=new Date(n+`-01`).toLocaleDateString(`en-US`,{month:`long`,year:`numeric`});Z(q.filter(e=>e.date.startsWith(n)),r)}))}function ze(e){let t=q.find(t=>t.id===e);t&&(X=e,document.getElementById(`sp-title`).textContent=t.title,document.getElementById(`sp-date`).textContent=$(t.date),document.getElementById(`sp-topic`).textContent=t.topic,document.getElementById(`sp-body`).innerHTML=t.html,Ve(t),document.getElementById(`post-list-view`).classList.add(`hidden`),document.getElementById(`single-post-view`).classList.add(`active`),window.scrollTo({top:0,behavior:`smooth`}))}function Be(){X=null,document.getElementById(`post-list-view`).classList.remove(`hidden`),document.getElementById(`single-post-view`).classList.remove(`active`)}function Ve(e){let t=document.getElementById(`comments-list`),n=[...e.comments,...J[e.id]||[]];t.innerHTML=n.length?n.map(e=>`
        <div class="comment">
          <div class="comment-avatar">${(e.initials||e.author.slice(0,2)).toUpperCase()}</div>
          <div class="comment-body">
            <p class="comment-author">${e.author}</p>
            <p class="comment-date">${e.date}</p>
            <p class="comment-text">${e.text}</p>
          </div>
        </div>`).join(``):`<p style="font-size:.87rem;color:var(--muted);margin-bottom:1rem;">No comments yet.</p>`,Q()}function Q(){let e=document.getElementById(`auth-status`),t=document.getElementById(`auth-toggle-btn`),n=document.getElementById(`login-notice`),r=document.getElementById(`comment-form`);Y?(e.textContent=`Signed in as Demo User.`,t.textContent=`Sign out`,n.style.display=`none`,r.classList.add(`visible`)):(e.textContent=`You are not logged in.`,t.textContent=`Sign in (demo)`,n.style.display=``,r.classList.remove(`visible`))}function He(){let e=document.getElementById(`comment-input`),t=e.value.trim();!t||!X||(J[X]||(J[X]=[]),J[X].push({author:`Demo User`,initials:`DU`,date:new Date().toLocaleDateString(`en-US`,{month:`short`,day:`numeric`,year:`numeric`}),text:t}),e.value=``,Ve(q.find(e=>e.id===X)))}function Ue(){let e={active:`Active`,archived:`Archived`,wip:`In Progress`},t=document.getElementById(`projects-grid`);t.innerHTML=Fe.map(t=>`
    <div class="project-card">
      <div class="project-card-header">
        <span class="project-name">${t.name}</span>
        <span class="project-status status-${t.status}">${e[t.status]}</span>
      </div>
      <p class="project-desc">${t.desc}</p>
      <div class="project-tags">
        ${t.tags.map(e=>`<span class="tech-tag">${e}</span>`).join(``)}
      </div>
      <div class="project-links">
        ${t.links.map(e=>`
          <a class="project-link ${e.primary?`project-link-primary`:`project-link-secondary`}"
             href="${e.url}" target="_blank" rel="noopener">
            ${e.primary?We():``}${e.label}
          </a>`).join(``)}
      </div>
    </div>`).join(``)}function $(e){return e?new Date(e+`T00:00:00`).toLocaleDateString(`en-US`,{month:`long`,day:`numeric`,year:`numeric`}):``}function We(){return`<svg viewBox="0 0 16 16"><path d="M8.636 3.5a.5.5 0 0 0-.5-.5H1.5A1.5 1.5 0 0 0 0 4.5v10A1.5 1.5 0 0 0 1.5 16h10a1.5 1.5 0 0 0 1.5-1.5V7.864a.5.5 0 0 0-1 0V14.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h6.636a.5.5 0 0 0 .5-.5z"/><path d="M16 .5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.793L6.146 9.146a.5.5 0 1 0 .708.708L15 1.707V5.5a.5.5 0 0 0 1 0v-5z"/></svg>`}document.addEventListener(`DOMContentLoaded`,()=>{Ie(),document.getElementById(`theme-toggle`).addEventListener(`click`,Le),document.querySelector(`.nav-logo`).addEventListener(`click`,()=>K(`about`)),document.getElementById(`tab-about`).addEventListener(`click`,()=>K(`about`)),document.getElementById(`tab-blog`).addEventListener(`click`,()=>K(`blog`)),document.getElementById(`tab-projects`).addEventListener(`click`,()=>K(`projects`)),document.getElementById(`back-btn`).addEventListener(`click`,Be),document.getElementById(`auth-toggle-btn`).addEventListener(`click`,()=>{Y=!Y,Q()}),document.getElementById(`login-notice-link`).addEventListener(`click`,e=>{e.preventDefault(),Y=!0,Q()}),document.getElementById(`submit-comment-btn`).addEventListener(`click`,He),document.getElementById(`clear-comment-btn`).addEventListener(`click`,()=>{document.getElementById(`comment-input`).value=``}),document.getElementById(`yr`).textContent=new Date().getFullYear(),q=Pe(),Z(),Re(),Ue()});