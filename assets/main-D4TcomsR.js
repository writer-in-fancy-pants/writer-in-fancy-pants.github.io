...
`):[],a={type:`table`,raw:t[0],header:[],align:[],rows:[]};if(n.length===r.length){for(let e of r)/^ *-+: *$/.test(e)?a.align.push(`right`):/^ *:-+: *$/.test(e)?a.align.push(`center`):/^ *:-+ *$/.test(e)?a.align.push(`left`):a.align.push(null);for(let e of n)a.header.push({text:e,tokens:this.lexer.inline(e)});for(let e of i)a.rows.push(v(e,a.header.length).map(e=>({text:e,tokens:this.lexer.inline(e)})));return a}}lheading(e){let t=this.rules.block.lheading.exec(e);if(t)return{type:`heading`,raw:t[0],depth:t[2].charAt(0)===`=`?1:2,text:t[1],tokens:this.lexer.inline(t[1])}}paragraph(e){let t=this.rules.block.paragraph.exec(e);if(t){let e=t[1].charAt(t[1].length-1)===`
`?t[1].slice(0,-1):t[1];return{type:`paragraph`,raw:t[0],text:e,tokens:this.lexer.inline(e)}}}text(e){let t=this.rules.block.text.exec(e);if(t)return{type:`text`,raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(e){let t=this.rules.inline.escape.exec(e);if(t)return{type:`escape`,raw:t[0],text:m(t[1])}}tag(e){let t=this.rules.inline.tag.exec(e);if(t)return!this.lexer.state.inLink&&/^<a /i.test(t[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&/^<\/a>/i.test(t[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&/^<(pre|code|kbd|script)(\s|>)/i.test(t[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&/^<\/(pre|code|kbd|script)(\s|>)/i.test(t[0])&&(this.lexer.state.inRawBlock=!1),{type:`html`,raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:t[0]}}link(e){let t=this.rules.inline.link.exec(e);if(t){let e=t[2].trim();if(!this.options.pedantic&&/^</.test(e)){if(!/>$/.test(e))return;let t=y(e.slice(0,-1),`\\`);if((e.length-t.length)%2==0)return}else{let e=re(t[2],`()`);if(e>-1){let n=(t[0].indexOf(`!`)===0?5:4)+t[1].length+e;t[2]=t[2].substring(0,e),t[0]=t[0].substring(0,n).trim(),t[3]=``}}let n=t[2],r=``;if(this.options.pedantic){let e=/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(n);e&&(n=e[1],r=e[3])}else r=t[3]?t[3].slice(1,-1):``;return n=n.trim(),/^</.test(n)&&(n=this.options.pedantic&&!/>$/.test(e)?n.slice(1):n.slice(1,-1)),b(t,{href:n&&n.replace(this.rules.inline.anyPunctuation,`$1`),title:r&&r.replace(this.rules.inline.anyPunctuation,`$1`)},t[0],this.lexer)}}reflink(e,t){let n;if((n=this.rules.inline.reflink.exec(e))||(n=this.rules.inline.nolink.exec(e))){let e=t[(n[2]||n[1]).replace(/\s+/g,` `).toLowerCase()];if(!e){let e=n[0].charAt(0);return{type:`text`,raw:e,text:e}}return b(n,e,n[0],this.lexer)}}emStrong(e,t,n=``){let r=this.rules.inline.emStrongLDelim.exec(e);if(r&&!(r[3]&&n.match(/[\p{L}\p{N}]/u))&&(!(r[1]||r[2])||!n||this.rules.inline.punctuation.exec(n))){let n=[...r[0]].length-1,i,a,o=n,s=0,c=r[0][0]===`*`?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(c.lastIndex=0,t=t.slice(-1*e.length+n);(r=c.exec(t))!=null;){if(i=r[1]||r[2]||r[3]||r[4]||r[5]||r[6],!i)continue;if(a=[...i].length,r[3]||r[4]){o+=a;continue}else if((r[5]||r[6])&&n%3&&!((n+a)%3)){s+=a;continue}if(o-=a,o>0)continue;a=Math.min(a,a+o+s);let t=[...r[0]][0].length,c=e.slice(0,n+r.index+t+a);if(Math.min(n,a)%2){let e=c.slice(1,-1);return{type:`em`,raw:c,text:e,tokens:this.lexer.inlineTokens(e)}}let l=c.slice(2,-2);return{type:`strong`,raw:c,text:l,tokens:this.lexer.inlineTokens(l)}}}}codespan(e){let t=this.rules.inline.code.exec(e);if(t){let e=t[2].replace(/\n/g,` `),n=/[^ ]/.test(e),r=/^ /.test(e)&&/ $/.test(e);return n&&r&&(e=e.substring(1,e.length-1)),e=m(e,!0),{type:`codespan`,raw:t[0],text:e}}}br(e){let t=this.rules.inline.br.exec(e);if(t)return{type:`br`,raw:t[0]}}del(e){let t=this.rules.inline.del.exec(e);if(t)return{type:`del`,raw:t[0],text:t[2],tokens:this.lexer.inlineTokens(t[2])}}autolink(e){let t=this.rules.inline.autolink.exec(e);if(t){let e,n;return t[2]===`@`?(e=m(t[1]),n=`mailto:`+e):(e=m(t[1]),n=e),{type:`link`,raw:t[0],text:e,href:n,tokens:[{type:`text`,raw:e,text:e}]}}}url(e){let t;if(t=this.rules.inline.url.exec(e)){let e,n;if(t[2]===`@`)e=m(t[0]),n=`mailto:`+e;else{let r;do r=t[0],t[0]=this.rules.inline._backpedal.exec(t[0])?.[0]??``;while(r!==t[0]);e=m(t[0]),n=t[1]===`www.`?`http://`+t[0]:t[0]}return{type:`link`,raw:t[0],text:e,href:n,tokens:[{type:`text`,raw:e,text:e}]}}}inlineText(e){let t=this.rules.inline.text.exec(e);if(t){let e;return e=this.lexer.state.inRawBlock?t[0]:m(t[0]),{type:`text`,raw:t[0],text:e}}}},ae=/^(?: *(?:\n|$))+/,oe=/^( {4}[^\n]+(?:\n(?: *(?:\n|$))*)?)+/,se=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,S=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,ce=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,C=/(?:[*+-]|\d{1,9}[.)])/,w=h(/^(?!bull |blockCode|fences|blockquote|heading|html)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html))+?)\n {0,3}(=+|-+) *(?:\n+|$)/).replace(/bull/g,C).replace(/blockCode/g,/ {4}/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).getRegex(),T=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,le=/^[^\n]+/,E=/(?!\s*\])(?:\\.|[^\[\]\\])+/,ue=h(/^ {0,3}\[(label)\]: *(?:\n *)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n *)?| *\n *)(title))? *(?:\n+|$)/).replace(`label`,E).replace(`title`,/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),de=h(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,C).getRegex(),D=`address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul`,O=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,fe=h(`^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n *)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$))`,`i`).replace(`comment`,O).replace(`tag`,D).replace(`attribute`,/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),k=h(T).replace(`hr`,S).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,D).getRegex(),A={blockquote:h(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace(`paragraph`,k).getRegex(),code:oe,def:ue,fences:se,heading:ce,hr:S,html:fe,lheading:w,list:de,newline:ae,paragraph:k,table:_,text:le},pe=h(`^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)`).replace(`hr`,S).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`blockquote`,` {0,3}>`).replace(`code`,` {4}[^\\n]`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,D).getRegex(),me={...A,table:pe,paragraph:h(T).replace(`hr`,S).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`table`,pe).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,D).getRegex()},he={...A,html:h(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace(`comment`,O).replace(/tag/g,`(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b`).getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:_,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:h(T).replace(`hr`,S).replace(`heading`,` *#{1,6} *[^
]`).replace(`lheading`,w).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`|fences`,``).replace(`|list`,``).replace(`|html`,``).replace(`|tag`,``).getRegex()},j=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,ge=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,M=/^( {2,}|\\)\n(?!\s*$)/,_e=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,N=`\\p{P}\\p{S}`,ve=h(/^((?![*_])[\spunctuation])/,`u`).replace(/punctuation/g,N).getRegex(),ye=/\[[^[\]]*?\]\([^\(\)]*?\)|`[^`]*?`|<[^<>]*?>/g,be=h(/^(?:\*+(?:((?!\*)[punct])|[^\s*]))|^_+(?:((?!_)[punct])|([^\s_]))/,`u`).replace(/punct/g,N).getRegex(),xe=h(`^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)[punct](\\*+)(?=[\\s]|$)|[^punct\\s](\\*+)(?!\\*)(?=[punct\\s]|$)|(?!\\*)[punct\\s](\\*+)(?=[^punct\\s])|[\\s](\\*+)(?!\\*)(?=[punct])|(?!\\*)[punct](\\*+)(?!\\*)(?=[punct])|[^punct\\s](\\*+)(?=[^punct\\s])`,`gu`).replace(/punct/g,N).getRegex(),Se=h(`^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)[punct](_+)(?=[\\s]|$)|[^punct\\s](_+)(?!_)(?=[punct\\s]|$)|(?!_)[punct\\s](_+)(?=[^punct\\s])|[\\s](_+)(?!_)(?=[punct])|(?!_)[punct](_+)(?!_)(?=[punct])`,`gu`).replace(/punct/g,N).getRegex(),Ce=h(/\\([punct])/,`gu`).replace(/punct/g,N).getRegex(),we=h(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace(`scheme`,/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace(`email`,/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Te=h(O).replace(`(?:-->|$)`,`-->`).getRegex(),Ee=h(`^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>`).replace(`comment`,Te).replace(`attribute`,/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),P=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,De=h(/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/).replace(`label`,P).replace(`href`,/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/).replace(`title`,/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Oe=h(/^!?\[(label)\]\[(ref)\]/).replace(`label`,P).replace(`ref`,E).getRegex(),ke=h(/^!?\[(ref)\](?:\[\])?/).replace(`ref`,E).getRegex(),F={_backpedal:_,anyPunctuation:Ce,autolink:we,blockSkip:ye,br:M,code:ge,del:_,emStrongLDelim:be,emStrongRDelimAst:xe,emStrongRDelimUnd:Se,escape:j,link:De,nolink:ke,punctuation:ve,reflink:Oe,reflinkSearch:h(`reflink|nolink(?!\\()`,`g`).replace(`reflink`,Oe).replace(`nolink`,ke).getRegex(),tag:Ee,text:_e,url:_},Ae={...F,link:h(/^!?\[(label)\]\((.*?)\)/).replace(`label`,P).getRegex(),reflink:h(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace(`label`,P).getRegex()},I={...F,escape:h(j).replace(`])`,`~|])`).getRegex(),url:h(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,`i`).replace(`email`,/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])([\s\S]*?[^\s~])\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},je={...I,br:h(M).replace(`{2,}`,`*`).getRegex(),text:h(I.text).replace(`\\b_`,`\\b_| {2,}\\n`).replace(/\{2,\}/g,`*`).getRegex()},L={normal:A,gfm:me,pedantic:he},R={normal:F,gfm:I,breaks:je,pedantic:Ae},z=class e{tokens;options;state;tokenizer;inlineQueue;constructor(e){this.tokens=[],this.tokens.links=Object.create(null),this.options=e||o,this.options.tokenizer=this.options.tokenizer||new x,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let t={block:L.normal,inline:R.normal};this.options.pedantic?(t.block=L.pedantic,t.inline=R.pedantic):this.options.gfm&&(t.block=L.gfm,this.options.breaks?t.inline=R.breaks:t.inline=R.gfm),this.tokenizer.rules=t}static get rules(){return{block:L,inline:R}}static lex(t,n){return new e(n).lex(t)}static lexInline(t,n){return new e(n).inlineTokens(t)}lex(e){e=e.replace(/\r\n|\r/g,`
...
`)){let n=e.indexOf(`:`);if(n===-1)continue;let r=e.slice(0,n).trim(),i=e.slice(n+1).trim();(i.startsWith(`"`)&&i.endsWith(`"`)||i.startsWith(`'`)&&i.endsWith(`'`))&&(i=i.slice(1,-1)),t[r]=i}return{meta:t,body:i.trim()}}function Pe(){let e=[];for(let[,t]of Object.entries(Me)){let{meta:n,body:r}=Ne(t);!n.id||!n.title||e.push({id:n.id,title:n.title,date:n.date||``,topic:n.topic||`General`,excerpt:n.excerpt||``,html:G.parse(r),comments:[]})}return e.sort((e,t)=>t.date.localeCompare(e.date))}var Fe=[{name:`Muse 2 EEG Dashboard`,status:`active`,desc:`Dashboard to visualize and compare EEG sessions using various neurofeedback metrics and frequency spectrum power distribution. Upload csv files with "timestamps,TF9,AF7,AF8,TF10" header and signal ordering. Other recordings should be converted to this format before uploading using conversion tools provided in the repo`,tags:[`eeg`,`neurofeedback`,`python`,`js`,`open source`,`dashboard`],links:[{label:`GitHub`,url:`https://github.com/writer-in-fancy-pants/muse2-eeg-dashboard`,primary:!1},{label:`Dashboard`,url:`https://writer-in-fancy-pants.github.io/muse2-eeg-dashboard/`,primary:!0}]},{name:`Meditations`,status:`active`,desc:`Live neurofeedback / biofeedback training and monitored meditation via stream from health devices (EEG, Heart rate, etc).`,tags:[`alpha/theta`,`hrv`,`neurofeedback`,`python`,`audio`,`js`,`open source`],links:[{label:`GitHub`,url:`https://github.com/writer-in-fancy-pants/meditations`,primary:!1},{label:`Dashboard`,url:`https://writer-in-fancy-pants.github.io/meditations/`,primary:!0}]},{name:`Mind Acoustic Tools`,status:`active`,desc:`Tools that use spatial (stereo) audio. Currently supports Hearing Test, EMDR self-therapy, and guided meditations. Work in progress, would love feedback on expected features.`,tags:[`audio`,`emdr`,`python`,`js`,`open source`,`dashboard`],links:[{label:`GitHub`,url:`https://github.com/writer-in-fancy-pants/mind-audio-tools`,primary:!1},{label:`Dashboard`,url:`https://writer-in-fancy-pants.github.io/mind-audio-tools/`,primary:!0}]}];function Ie(){K(localStorage.getItem(`theme`)||`dark`)}function K(e){document.documentElement.setAttribute(`data-theme`,e),localStorage.setItem(`theme`,e);let t=document.getElementById(`theme-toggle`);t&&(t.textContent=e===`dark`?`☀️ Light`:`🌙 Dark`)}function Le(){K(document.documentElement.getAttribute(`data-theme`)===`dark`?`light`:`dark`)}function q(e){document.querySelectorAll(`.page`).forEach(e=>e.classList.remove(`active`)),document.querySelectorAll(`.nav-tabs button`).forEach(e=>e.classList.remove(`active`)),document.getElementById(e).classList.add(`active`),document.getElementById(`tab-`+e).classList.add(`active`)}var J=[],Y={},X=!1,Z=null;function Q(e,t){let n=document.getElementById(`posts-container`);n.innerHTML=``;let r=document.querySelector(`.blog-page-title`);if(r.innerHTML=t||`Writing`,t){let e=document.createElement(`a`);e.href=`#`,e.style.cssText=`font-size:.8rem;color:var(--accent);margin-left:.7rem;`,e.textContent=`(clear)`,e.onclick=e=>{e.preventDefault(),Q(J)},r.appendChild(e)}let i=e||J;if(!i.length){n.innerHTML=`<p style="color:var(--muted);font-size:.9rem;padding:1.5rem 0;">No posts found.</p>`;return}i.forEach(e=>{let t=document.createElement(`div`);t.className=`post-card`,t.innerHTML=`
    ...
    `,t.querySelectorAll(`[data-id]`).forEach(t=>t.addEventListener(`click`,t=>{t.preventDefault(),ze(e.id)})),n.appendChild(t)})}function Re(){let e=[...new Set(J.map(e=>e.topic))],t=document.getElementById(`topic-index`);t.innerHTML=e.map(e=>`<li><a href="#" class="topic-tag" data-topic="${e}">${e}</a></li>`).join(``),t.querySelectorAll(`[data-topic]`).forEach(e=>e.addEventListener(`click`,t=>{t.preventDefault();let n=e.dataset.topic;Q(J.filter(e=>e.topic===n),`Topic: ${n}`)}));let n={};J.forEach(e=>{let t=e.date.slice(0,7);n[t]||(n[t]=[]),n[t].push(e)});let r=document.getElementById(`date-index`);r.innerHTML=Object.entries(n).sort(([e],[t])=>t.localeCompare(e)).map(([e,t])=>`<li><a href="#" style="font-weight:500;" data-ym="${e}">${new Date(e+`-01`).toLocaleDateString(`en-US`,{month:`short`,year:`numeric`})}</a></li>${t.map(e=>`<li><a href="#" style="padding-left:.7rem;" data-id="${e.id}">↳ ${e.title.length>28?e.title.slice(0,28)+`…`:e.title}</a></li>`).join(``)}`).join(``),r.querySelectorAll(`[data-id]`).forEach(e=>e.addEventListener(`click`,t=>{t.preventDefault(),ze(e.dataset.id)})),r.querySelectorAll(`[data-ym]`).forEach(e=>e.addEventListener(`click`,t=>{t.preventDefault();let n=e.dataset.ym,r=new Date(n+`-01`).toLocaleDateString(`en-US`,{month:`long`,year:`numeric`});Q(J.filter(e=>e.date.startsWith(n)),r)}))}function ze(e){let t=J.find(t=>t.id===e);t&&(Z=e,document.getElementById(`sp-title`).textContent=t.title,document.getElementById(`sp-date`).textContent=We(t.date),document.getElementById(`sp-topic`).textContent=t.topic,document.getElementById(`sp-body`).innerHTML=t.html,Ve(t),document.getElementById(`post-list-view`).classList.add(`hidden`),document.getElementById(`single-post-view`).classList.add(`active`),window.scrollTo({top:0,behavior:`smooth`}))}function Be(){Z=null,document.getElementById(`post-list-view`).classList.remove(`hidden`),document.getElementById(`single-post-view`).classList.remove(`active`)}function Ve(e){let t=document.getElementById(`comments-list`),n=[...e.comments,...Y[e.id]||[]];t.innerHTML=n.length?n.map(e=>`
        <div class="comment">
        ...
        </div>`).join(``):`<p style="font-size:.87rem;color:var(--muted);margin-bottom:1rem;">No comments yet.</p>`,$()}function $(){let e=document.getElementById(`auth-status`),t=document.getElementById(`auth-toggle-btn`),n=document.getElementById(`login-notice`),r=document.getElementById(`comment-form`);X?(e.textContent=`Signed in as Demo User.`,t.textContent=`Sign out`,n.style.display=`none`,r.classList.add(`visible`)):(e.textContent=`You are not logged in.`,t.textContent=`Sign in (demo)`,n.style.display=``,r.classList.remove(`visible`))}function He(){let e=document.getElementById(`comment-input`),t=e.value.trim();!t||!Z||(Y[Z]||(Y[Z]=[]),Y[Z].push({author:`Demo User`,initials:`DU`,date:new Date().toLocaleDateString(`en-US`,{month:`short`,day:`numeric`,year:`numeric`}),text:t}),e.value=``,Ve(J.find(e=>e.id===Z)))}function Ue(){let e={active:`Active`,archived:`Archived`,wip:`In Progress`},t=document.getElementById(`projects-grid`);t.innerHTML=Fe.map(t=>`
      ...
      <div class="project-links">
        ${t.links.map(e=>`
          <a class="project-link ${e.primary?`project-link-primary`:`project-link-secondary`}"
            ...
            ${e.primary?Ge():``}${e.label}
          </a>`).join(``)}
      </div>
    </div>`).join(``)}function We(e){return e?new Date(e+`T00:00:00`).toLocaleDateString(`en-US`,{month:`long`,day:`numeric`,year:`numeric`}):``}function Ge(){return`<svg viewBox="0 0 16 16"><path d="M8.636 3.5a.5.5 0 0 0-.5-.5H1.5A1.5 1.5 0 0 0 0 4.5v10A1.5 1.5 0 0 0 1.5 16h10a1.5 1.5 0 0 0 1.5-1.5V7.864a.5.5 0 0 0-1 0V14.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h6.636a.5.5 0 0 0 .5-.5z"/><path d="M16 .5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.793L6.146 9.146a.5.5 0 1 0 .708.708L15 1.707V5.5a.5.5 0 0 0 1 0v-5z"/></svg>`}document.addEventListener(`DOMContentLoaded`,()=>{Ie(),document.getElementById(`theme-toggle`).addEventListener(`click`,Le),document.querySelector(`.nav-logo`).addEventListener(`click`,()=>q(`about`)),document.getElementById(`tab-about`).addEventListener(`click`,()=>q(`about`)),document.getElementById(`tab-blog`).addEventListener(`click`,()=>q(`blog`)),document.getElementById(`tab-projects`).addEventListener(`click`,()=>q(`projects`)),document.getElementById(`back-btn`).addEventListener(`click`,Be),document.getElementById(`auth-toggle-btn`).addEventListener(`click`,()=>{X=!X,$()}),document.getElementById(`login-notice-link`).addEventListener(`click`,e=>{e.preventDefault(),X=!0,$()}),document.getElementById(`submit-comment-btn`).addEventListener(`click`,He),document.getElementById(`clear-comment-btn`).addEventListener(`click`,()=>{document.getElementById(`comment-input`).value=``}),document.getElementById(`yr`).textContent=new Date().getFullYear(),J=Pe(),Q(),Re(),Ue()});